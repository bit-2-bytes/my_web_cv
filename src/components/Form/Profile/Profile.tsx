      ...
      <div className="p-sameline">
        ...
        <div className="p-field">
          ...
          <Field
            type="text"
            id="organisation"
            placeholder="Eg: XYZ Technologies"
        ...
        <div className="p-field">
          ...
          <Field
            type="text"
            id="linkedin"
            placeholder="Eg: https://www.linkedin.com/in/123/"
        ...
        <div className="p-field">
          ...
          <Field
            type="text"
            id="github"
            placeholder="Eg: https://github.com/123"
        ...
        <div className="p-field">
          ...
          <Field
            type="text"
            id="leetcode"
            placeholder="Eg: https://leetcode.com/123/"
        ...
        <div className="p-field">
          ...
          <Field
            type="text"
            id="stackoverflow"
            placeholder="Eg: https://stackoverflow.com/users/123"
            name="personalDetails.stackoverflow"
            as={InputText}
          />
        </div>
        ...
        <div className="p-sameline">
          <label htmlFor="adjectives">
            Phrases suitable to your work & you
          </label>
          <Field
            type="text"
            id="adjectives"
            placeholder="Eg: Continuous learner"
            name="personalDetails.adjectives[0]"
            as={InputText}
          />
          <Field
            type="text"
            id="adjectives"
            placeholder="Eg: Software Engineer"
            name="personalDetails.adjectives[1]"
            as={InputText}
          />
          <Field
            type="text"
            id="adjectives"
            placeholder="Eg: Hardworking"
            name="personalDetails.adjectives[2]"
            as={InputText}
          />
        </div>
      </div>
